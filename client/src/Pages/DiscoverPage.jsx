            ...
            <div className="scrollbar-hide mb-8 flex gap-2 overflow-x-auto pb-3">
              {categories.map((category) => (
                <button
                  ...
                  className={`min-h-10 whitespace-nowrap rounded-full border px-5 py-2.5 text-xs font-bold uppercase tracking-widest transition-all ${activeCategory === category
